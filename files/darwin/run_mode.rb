module Puppet
  module Util
    class RunMode
      ...
      def conf_dir
        which_dir(
          (Puppet.features.microsoft_windows? ? File.join(Dir::COMMON_APPDATA, "PuppetLabs", "puppet", "etc") : "/opt/operations/etc/puppet"),
          "~/.puppet"
        )
      end
      ...
      def var_dir
        which_dir(
          (Puppet.features.microsoft_windows? ? File.join(Dir::COMMON_APPDATA, "PuppetLabs", "puppet", "var") : "/opt/operations/var/lib/puppet"),
          "~/.puppet/var"
        )
      end
