  ...
  case $domain {
    "puppetlabs.lan": {
      yumrepo { 'puppetlabs_os':
        ...
        baseurl    => "http://yo.delivery.puppetlabs.net/cent${lsbmajdistrelease}latestserver-$architecture/RPMS.os",
        enabled    => 1,
        gpgcheck   => 1,
        keepalive  => 1,
      }
      yumrepo { 'puppetlabs_updates':
        ...
        baseurl    => "http://yo.delivery.puppetlabs.net/cent${lsbmajdistrelease}latestserver-$architecture/RPMS.updates",
        enabled    => 1,
        gpgcheck   => 1,
        keepalive  => 1,
      }
